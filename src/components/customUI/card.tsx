...
export function Card() {
  return (
    ...
    <div
      className="group flex justify-between items-center bg-[#242528] shadow-sm/25  h-12 text-md text-gray-400 transition-all hover:ring-3 hover:ring-blue-300 mr-5 p-2 
    ...
    >
      <div className="flex items-center gap-1 -translate-x-3 group-hover:translate-x-0 transition-all duration-250 ease-out">
        ...
        />
        <span className="text-base font-bold">Card title goes here</span>
      </div>
